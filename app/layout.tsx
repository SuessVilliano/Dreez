...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "House music. Human connection. Find Dreez live, discover events, enter the live room and follow the frequency.",
    siteName: "Dreez",
    images: [{ url: "/images/sunset.webp", width: 1200, height: 630, alt: "Dreez — Follow the feeling" }],
  },
  ...
  "@graph": [
    {
      ...
      alternateName: "DREEZ",
      jobTitle: "DJ",
      description: "Tampa Bay house-music DJ focused on house music, human connection and live fan experiences.",
      url: siteUrl,
      sameAs: ["https://www.instagram.com/__dreezz/"],
      knowsAbout: ["House music", "DJ performance", "Live music"],
      homeLocation: { "@type": "Place", name: "Tampa Bay, Florida" },
    },
    {
      "@type": "WebSite",
      "@id": `${siteUrl}/#website`,
      url: siteUrl,
      name: "Dreez",
      description: "Official Dreez fan site, events, live room, booking and merch hub.",
      about: { "@id": `${siteUrl}/#dreez` },
    },
  ],
};
