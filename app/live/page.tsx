...
export default function LiveRoom() {
  ...
  return (
    <main className="live-room-page">
      ...
      <section className="live-player-shell" aria-label="Dreez Live Room">
        {streamUrl ? (
          <iframe src={streamUrl} title="Dreez Live Room" allow="autoplay; encrypted-media; picture-in-picture; fullscreen" allowFullScreen />
        ) : (
          <div className="live-offline">
            ...
            <p>The room is ready. When Dreez switches on the official stream from backstage, the player appears right here.</p>
      ...
      <section className="live-room-grid">
        ...
        <article><b>●</b><h3>Built for the inner circle.</h3><p>Keep this page bookmarked. This is the home base whenever Dreez and the team decide to turn the cameras on.</p></article>
        <article><b>↗</b><h3>Catch the signal early.</h3><p>Follow Dreez and join the email list from the homepage so a spontaneous session does not pass you by.</p></article>
      </section>
    </main>
  );
}
